...
def ray_deps_setup():
    ...
    auto_http_archive(
        ...
        url = "https://github.com/bazelbuild/rules_jvm_external/releases/download/5.0/rules_jvm_external-5.0.tar.gz",
        sha256 = "8c3cd0ce6aa3dd8c01a414385e0a3807c7a14c769ca0aa3c53fb135c91f9198c",
    )
